    ...
    <MobilePage title="Settings">
      ...
      <div className="glass rounded-[2rem] p-6 mb-8 flex items-center gap-4">
        <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center shadow-lg shadow-primary/30">
          <span className="text-xl font-display font-bold text-primary-foreground">S</span>
        </div>
        <div>
          <h2 className="text-xl font-bold font-display text-foreground">Sarah (Me)</h2>
          <p className="text-muted-foreground text-sm font-medium">sarah@example.com</p>
        </div>
      </div>
